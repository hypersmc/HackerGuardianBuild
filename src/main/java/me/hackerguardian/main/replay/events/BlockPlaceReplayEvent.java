...
public final class BlockPlaceReplayEvent implements ReplayEvent {
    ...
    public BlockPlaceReplayEvent(String world, int x, int y, int z, String blockType) {
        this.world = world;
        this.x = x; this.y = y; this.z = z;
        this.blockType = blockType;
    }

    public static BlockPlaceReplayEvent from(Block b) {
        Location l = b.getLocation();
        String w = (l.getWorld() != null) ? l.getWorld().getName() : "world";
        return new BlockPlaceReplayEvent(w, l.getBlockX(), l.getBlockY(), l.getBlockZ(), b.getType().name());
    }
