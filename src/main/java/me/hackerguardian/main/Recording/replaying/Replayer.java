...
import me.hackerguardian.main.Recording.data.types.ItemData;
import me.hackerguardian.main.Recording.data.types.LocationData;
import me.hackerguardian.main.Recording.data.types.SpawnData;
import me.hackerguardian.main.Recording.filesys.ConfigManager;
import me.hackerguardian.main.Recording.utils.entities.IEntity;
import me.hackerguardian.main.Recording.utils.entities.INPC;
...
public class Replayer {
    ...
    public void sendMessage(String message) {
        if (message != null) {
            this.watcher.sendMessage(hackerguardian.getInstance().playertext(hackerguardian.getInstance().prefix + message));
        }
    }
}
