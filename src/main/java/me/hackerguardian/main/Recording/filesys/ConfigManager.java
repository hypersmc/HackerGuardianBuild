...
public class ConfigManager {
    ...
    public static File sqlFile = new File(hackerguardian.getInstance().getDataFolder(), "mysqlrecording.yml");
    public static FileConfiguration sqlCfg = YamlConfiguration.loadConfiguration(sqlFile);

    public static File file = new File(hackerguardian.getInstance().getDataFolder(), "configrecording.yml");
