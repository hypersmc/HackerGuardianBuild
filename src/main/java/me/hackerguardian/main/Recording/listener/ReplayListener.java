...
import me.hackerguardian.main.Recording.replaying.ReplayPacketListener;
...
public class ReplayListener extends AbstractListener {
    ...
    public void onInteract(PlayerInteractEvent e) {
        if (e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) {
            ...
            if (ReplayHelper.replaySessions.containsKey(p.getName())) {
                ...
                ItemConfigType itemType = ItemConfig.getByIdAndName(p.getInventory().getItemInMainHand().getType(), meta.getDisplayName().replace("§", "&"));
            ...
            if (ReplayHelper.replaySessions.containsKey(p.getName())) {
                ...
                if (e.getView().getTitle().equalsIgnoreCase("§7Teleporter")) {
                    ...
                    if (e.getCurrentItem() != null && e.getCurrentItem().getItemMeta() != null) {
                        String owner = e.getCurrentItem().getItemMeta().getDisplayName().replaceAll("§6", "").replaceAll("&6", "");
    ...
    public void onWorldChange(PlayerChangedWorldEvent e) {
        ...
        if (ReplayHelper.replaySessions.containsKey(p.getName())) {
            ...
            }.runTaskLater(hackerguardian.getInstance(), 20);
        }
    }
