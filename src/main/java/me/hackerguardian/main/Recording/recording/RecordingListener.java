...
import me.hackerguardian.main.Recording.filesys.MessageBuilder;
import me.hackerguardian.main.Recording.listener.AbstractListener;
import me.hackerguardian.main.Recording.data.ActionData;
import me.hackerguardian.main.Recording.data.ActionType;
import me.hackerguardian.main.Recording.data.types.*;
import me.hackerguardian.main.Recording.utils.ItemUtils;
...
public class RecordingListener extends AbstractListener {
    ...
    public void onInteract(PlayerInteractEvent e) {
        ...
        if (recorder.getPlayers().contains(p.getName())) {
            ...
            if (e.getAction() == Action.LEFT_CLICK_BLOCK && p.getTargetBlock((Set<Material>) null, 5).getType() == Material.FIRE) {
                ...
                ItemData before = new ItemData(Material.FIRE, Material.AIR);
                ItemData after = new ItemData(Material.AIR, Material.AIR);
    ...
    public void onThrow(PlayerDropItemEvent e) {
        ...
        if (this.recorder.getPlayers().contains(p.getName())) {
            InvData data = NPCManager.copyFromPlayer(p, true, true);
            if (data.getMainHand() != null && p.getItemInHand() != null && p.getItemInHand().getAmount() <= 1 && p.getItemInHand().getType() == MaterialBridge.fromID(data.getMainHand().toString())) {
                data.setMainHand(null);
            }
    ...
    public void onPlace(BlockPlaceEvent e) {
        ...
        if (this.recorder.getPlayers().contains(p.getName())) {
            ...
            ItemData before = new ItemData(e.getBlockReplacedState().getType(), e.getBlockReplacedState().getData().getItemType());
            ItemData after = VersionUtil.isAbove(VersionEnum.V1_13) ? new ItemData(SerializableItemStack.fromMaterial(MaterialBridge.getBlockDataMaterial(e.getBlockPlaced()))) : new ItemData(e.getBlockPlaced().getType(), e.getBlockPlaced().getType());
    ...
    public void onBreak(BlockBreakEvent e) {
        ...
        if (this.recorder.getPlayers().contains(p.getName())) {
            ...
            ItemData before = VersionUtil.isAbove(VersionEnum.V1_13) ? new ItemData(SerializableItemStack.fromMaterial(MaterialBridge.getBlockDataMaterial(e.getBlock()))) : new ItemData(e.getBlock().getType(), e.getBlock().getType());
            ItemData after = new ItemData(Material.AIR, Material.AIR);
    ...
    public void onFill(PlayerBucketFillEvent e) {
        ...
        if (this.recorder.getPlayers().contains(p.getName())) {
            ...
            ItemData before = new ItemData(e.getBlockClicked().getState().getType(), e.getBlockClicked().getState().getData().getItemType());
            ItemData after = new ItemData(Material.AIR, Material.AIR);
    ...
    public void onEmpty(PlayerBucketEmptyEvent e) {
        ...
        if (this.recorder.getPlayers().contains(p.getName())) {
            ...
            ItemData before = new ItemData(block.getType(), block.getType());
            ItemData after = new ItemData(Material.LAVA_BUCKET, Material.BUCKET);
